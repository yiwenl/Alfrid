/* SiteCatalyst code version: H.25.1.4
...
s_account = evaluateAccount(s_account);
...
s.linkInternalFilters="javascript:,mercedes-benz.com,"+s.thisHost
...
function s_doPlugins(s) {
	...
	s.clickPast('s_kwcid','event27','event28');
